<template>
  <div id="headed">
    ...
    <ul class="tab">
      ...
      <li>
        <div class="body_bottom" @click="jump(3)" :class="{'active_color': index==3}">乒乓球</div>
      </li>
      <!--<li>-->
        <!--<div class="body_bottom" @click="jump(4)" :class="{'active_color': index==4}">羽毛球</div>-->
      <!--</li>-->
    </ul>
    <div class="line"></div>
    <!-- 是否滑动
...
<script>
  import goods from '../components/goods/goodsInfo'
